# import for Button UI
from telegram import InlineKeyboardButton, InlineKeyboardMarkup
from telegram.ext import Updater, CommandHandler, CallbackQueryHandler, ConversationHandler
import logging


# import for spammer bot
...
def run(update, context):    # the global synthax helps to refer to the global variable and not the block scope.
   ...
   print(query.data)
   if query.data == '0':
      context.bot.send_message(chat_id=update.effective_chat.id, text="Please click /spammer")
   elif query.data == '1':
      context.bot.send_message(chat_id=update.effective_chat.id, text="Please click /encikbot")
   elif query.data == '2':
      context.bot.send_message(chat_id=update.effective_chat.id, text="Please click /friend")
